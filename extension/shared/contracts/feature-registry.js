export const featureDescriptors = Object.freeze([
  {
...
export const contentFeatureDescriptors = featureDescriptors.filter((descriptor) =>
  descriptor.surfaces.includes('content')
);

export const featureModulePaths = contentFeatureDescriptors.map((descriptor) => descriptor.modulePath);

export const featureDescriptorsById = new Map(
  featureDescriptors.map((descriptor) => [descriptor.id, descriptor])
);

export function getFeatureDescriptor(featureId) {
